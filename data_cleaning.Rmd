---
title: "Social Protests Increase Donations to Federal Political Campaigns: Data Cleaning"
...
How do protests influence American political behavior? This project investigates how political protests affect an individual's willingness to donate money to a federal political campaign. In this markdown, I describe the data cleaning procedures associated with this project. Please note that running this script takes roughly 2.5 hours to run in total.
...
zip_to_county_data <- read_excel(here("raw_data/ZIP_COUNTY_092021.xlsx")) %>% 
  select(1, 2) %>% 
...
# Load to get full list of counties and zip codes
zip_to_county_data <- read_excel(here("/Users/nickpangakis/Library/CloudStorage/Box-Box/Project: Protests and Donations/code_and_data/raw_data/ZIP_COUNTY_092021.xlsx")) %>% 
  select(1, 2) %>% 
  # limit to unique zip codes (bc several zip codes lie in multiple counties)
  distinct_at(vars(ZIP), .keep_all = T)
...
candidate_2018 <- fread(here("/Users/nickpangakis/Library/CloudStorage/Box-Box/Project: Protests and Donations/code_and_data/raw_data/candidate_2018.txt"), 
...
candidate_2020 <- fread(here("/Users/nickpangakis/Library/CloudStorage/Box-Box/Project: Protests and Donations/code_and_data/raw_data/candidate_2020.txt"), 
                        sep = "|", header = FALSE, stringsAsFactors = FALSE)
candidate_2020 <- clean_candidate(candidate_2020, "2019|2020")
# 2021-2022: https://www.fec.gov/files/bulk-downloads/2022/cn22.zip
candidate_2022 <- fread(here("/Users/nickpangakis/Library/CloudStorage/Box-Box/Project: Protests and Donations/code_and_data/raw_data/candidate_2022.txt"), 
                        sep = "|", header = FALSE, stringsAsFactors = FALSE)
...
os_candidate_raw <- read_csv(here("/Users/nickpangakis/Desktop/AA - Penn 05 Spring 2022/data/candidaterace.csv"))
...
header <- fread(here("/Users/nickpangakis/Desktop/AA - Penn 05 Spring 2022/data/indiv_header_file.csv"))
...
fec_process <- function(){
  ...
  file <- "/Users/nickpangakis/Desktop/AA - Penn 05 Spring 2022/data/fec_2018.txt"
  ...
  file <- "/Users/nickpangakis/Desktop/AA - Penn 05 Spring 2022/data/fec_2020.txt"
  ...
  file <- "/Users/nickpangakis/Desktop/AA - Penn 05 Spring 2022/data/fec_2022.txt"
...
fec_cleaned <- fread(here("processed_data/fec_cleaned.csv"))
```
